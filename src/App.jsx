...
const T = {
  en: {
    ...
    backBtn: "Go Back", shareBtn: "🔗 Share Link", downloadBtn: "Download",
    ...
    langLabel: "Language", downloadStart: "Download started!",
  },
 ur: {
    name: "اردو", flag: "🇵🇰",
    ...
    backBtn: "واپس جائیں", shareBtn: "🔗 لنک شیئر کریں", downloadBtn: "ڈاؤنلوڈ",
    ...
    langLabel: "زبان", downloadStart: "ڈاؤنلوڈ شروع ہو گیا!",
  },
  hi: {
    name: "हिंदी", flag: "🇮🇳",
    ...
    backBtn: "वापस जाएं", shareBtn: "🔗 लिंक शेयर करें", downloadBtn: "डाउनलोड",
    ...
    langLabel: "भाषा", downloadStart: "डाउनलोड शुरू हो गया!",
  },
};
const SAMPLE_MOVIES = [
...
return (
    <div dir={isRtl ? "rtl" : "ltr"} style={{ minHeight: "100vh", background: "#0a0a0f", fontFamily: "'Segoe UI',system-ui,sans-serif", color: "#f0f0f0" }}>
      ...
      {toast && <div style={{ position: "fixed", bottom: 24,
                             {playing && (
          ...
          <div style={{ background: "#14141f", borderRadius: 16, maxWidth: 700, width: "100%", border: "1px solid rgba(255,255,255,0.1)", overflow: "hidden" }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ padding: "1rem 1.2rem 1.2rem" }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <button style={{ background: "#e50914", color: "#fff", border: "none", borderRadius: 6, padding: "9px 16px", fontWeight: 700, cursor: "pointer" }} onClick={copyLink}>{t.shareBtn}</button>
                <a href={playing.url} download={playing.title + ".mp4"} onClick={() => showToast("⬇️ " + t.downloadStart)} style={{ background: "linear-gradient(135deg,#1a6b1a,#0f4f0f)", color: "#fff", border: "none", borderRadius: 6, padding: "9px 16px", fontWeight: 700, cursor: "pointer", textDecoration: "none", display: "flex", alignItems: "center", gap: 6, fontSize: "0.9rem" }}>
                  ⬇️ {t.downloadBtn}
                </a>
          ...
          <div style={{ background: "#14141f", borderRadius: 16, maxWidth: 500, width: "100%", border: "1px solid rgba(255,255,255,0.1)", overflow: "hidden" }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ padding: "0.5rem 1.2rem 1.2rem" }}>
              ...
              <div style={{ border: "2px dashed rgba(229,9,20,0.35)", borderRadius: 10, padding: "1.5rem", textAlign: "center", background: "rgba(229,9,20,0.04)", cursor: "pointer", margin: "8px 0" }} onClick={() => fileRef.current.click()}>
                ...
                <input ref={fileRef} type="file" accept="video/*" style={{ display: "none" }} onChange={e => setUploadForm(p => ({ ...p, file: e.target.files[0] }))} />
              </div>
              <div style={{ border: "2px dashed rgba(255,255,255,0.1)", borderRadius: 10, padding: "0.9rem", textAlign: "center", cursor: "pointer", marginBottom: 10 }} onClick={() => thumbRef.current.click()}>
                ...
                <input ref={thumbRef} type="file" accept="image/*" style={{ display: "none" }} onChange={e => setUploadForm(p => ({ ...p, thumb: e.target.files[0] }))} />
              </div>
